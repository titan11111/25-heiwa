...
const events = {
    ...
    market: [
        {
            problem: "市場で大きな火事が発生し、周りの店が燃えそうです！",
            correctSpell: "みずだし",
            success: "魔法の水で火が消し止められました！危機一髪でしたが被害は最小限で済みました。",
            failure: "「た、大変です！その魔法じゃ火が広がってしまいます！水を呼ぶ魔法をお願いします！」"
        },
        {
            problem: "倉庫の商品が宙に浮き始め、落ちたら人が危険です！",
            correctSpell: "うきとめ",
            success: "浮いていた商品が地面に戻り、誰も怪我せずに済みました。",
            failure: "「勇者様、その魔法だともっと高く飛んでいきますよ〜！止める魔法をお願いします！」"
        },
        {
            problem: "旅人の財布が屋台の狭い隙間に落ちてしまいました！",
            correctSpell: "ぺたんこ",
            success: "体をぺたんこにして隙間から財布を取り出せました！旅人が感謝しています。",
            failure: "「あれれ？勇者様、それだと私が太っちゃいますよ〜💦 体を薄くする魔法をお願いします！」"
        }
    ],
    harbor: [
        {
            problem: "港で巨大な泡が湧き上がり、船がふわふわ浮いて流されそうです！",
            correctSpell: "うきとめ",
            success: "泡が落ち着き、船が元の位置に戻りました。泡の柔らかさにみんなちょっと癒やされました。",
            failure: "「あわわ！その魔法だと泡が弾けて船が遠くへ流されちゃいますよ〜😱 ふわふわを止める魔法をお願いします！」"
        },
        {
            problem: "港の倉庫から熱い潮風が吹き出し、港全体が蒸し風呂のようになっています！暑さで危険です！",
            correctSpell: "かぜきる",
            success: "潮風がピタッと止まり、ちょうどいい温度になりました。みんなサウナ気分で少しスッキリしています。",
            failure: "「むわ〜！その魔法だともっと暑くなっちゃいますよ〜😵 風を止める魔法をお願いします！」"
        },
        {
            problem: "巨大なクジラが港で歌い始め、波が大きく揺れて危険です！でも歌声が妙に心地よいです。",
            correctSpell: "ねむたれ",
            success: "クジラが静かに眠りにつき、波もおだやかに。寝息が子守歌みたいで港の人々も癒やされました。",
            failure: "「きゃ〜！その魔法だとクジラがもっとはしゃいでしまいますよ〜😰 眠らせる魔法をお願いします！」"
        }
    ],
    tower: []
};
